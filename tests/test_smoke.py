"""End-to-end smoke test: real env, a handful of episodes, must not crash or
produce NaNs. NOT a convergence test — just verifies the discrete SAC + HER +
epsilon-greedy-critic pipeline runs end-to-end."""
import math
